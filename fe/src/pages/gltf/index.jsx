...
function Model(props) {
  ...
  const animation = useGLTF("/model/dance.gltf");
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <group>
        ...
        /> */}
        <skinnedMesh
          material={model.nodes.Boy01_Body_Geo.materials}
          geometry={model.nodes.Boy01_Body_Geo.geometry}
          skeleton={model.nodes.Boy01_Body_Geo.skeleton}
        />
      </group>
    </group>
  );
